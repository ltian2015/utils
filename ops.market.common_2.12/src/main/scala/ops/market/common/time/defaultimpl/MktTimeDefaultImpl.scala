...
object DefaultCalendarFactory{
      ...
      val tradeCenterId:String,val decoderFactory:IntervalDecoderFactory) extends MktCalendar
 {
   ...
   override def equals(other:Any)=
      {
        other match {
          case that:MktCalendar=>this.tc.mRID==that.tradeCenter.mRID;
          case _ =>false;
        }
      }
     override def hashCode:Int=this.tc.mRID.hashCode()*47;
     override def toString:String="MktCalendar : "+this.tc.mRID;
 }
 /**
